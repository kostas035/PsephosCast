...
## Corpus Check
- 90 files · ~386,167 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 747 nodes · 1501 edges · 42 communities (35 shown, 7 thin omitted)
...
Cohesion: 0.07
Nodes (42): BLOCS, buildAnalysisFrame(), ISLANDS, REGIONS, generateDerivedBaseline(), GR_2015_MERGE_GROUPS, GR_BONUS_CONFIG, GR_CENTROID_OFFSETS (+34 more)

### Community 3 - "GreeceExport.jsx"
Cohesion: 0.07
Nodes (30): grCoalitionProbability(), grRunMonteCarlo(), percentile(), randn(), studentT(), BG_OPTIONS, covered(), ctrl (+22 more)
...
Cohesion: 0.14
Nodes (21): HOWTO, IconBarChart(), IconBuilding(), IconCamera(), IconClose(), IconContrast(), IconDice(), IconEye() (+13 more)
...
Cohesion: 0.14
Nodes (15): GR, grBuildScenario(), detectColumns(), finalisePolls(), GR_HEMI_POSITIONS, GR_ROW_COUNTS, GR_ROW_RADII, grAverageRecentPolls() (+7 more)

### Community 14 - "GreeceCorrelations.jsx"
Cohesion: 0.09
Nodes (23): ANALYSIS_MODULES, BASELINE_OPTIONS, BLOC_OPTIONS, DEMO_FIELDS, PARTY_OPTIONS, sectionTitleStyle, selectStyle, unemploymentHistFields() (+15 more)
...
Cohesion: 0.15
Nodes (9): GR_PARTY_DICT, DEFAULT_HIDDEN_PARTIES, POLL_PARTIES_MAPPING, T(), tPartyNameById(), useGreeceT(), MethodologyModal(), BTN_BASE (+1 more)
...
Cohesion: 0.08
Nodes (23): BivariatePanel(), DescriptivesPanel(), GroupPanel(), RegressionPanel(), sectionTitleStyle, SwingPanel(), GR_2015_SEAT_DIFF, buildReadout() (+15 more)
