# Graph Report - swingometer  (2026-07-18)

## Corpus Check
- 93 files · ~399,398 words
...
Cohesion: 0.14
Nodes (22): HOWTO, IconArrowLeft(), IconBriefcase(), IconBuilding(), IconCamera(), IconClose(), IconContrast(), IconDice() (+14 more)
...
Cohesion: 0.09
Nodes (25): GR_MUNI_DATA, GR_MUNI_PARTY_IDS, IconBallot(), IconBarChart(), IconCoins(), IconElder(), IconEyeOff(), IconMedal() (+17 more)
...
Cohesion: 0.17
Nodes (17): baseline, baselinePath, current, __dirname, write, ZERO_SLIDERS, computeEffectiveParties(), FIXED_SCENARIO_IDS (+9 more)
...
Cohesion: 0.22
Nodes (12): GR_DISTRICT_TURNOUT, GR_MULTIPLIERS, GR_STATE_BALLOT_EXCLUDED, grDistrictsForScenario(), grDemographicsForScenario(), grDemoZForScenario(), grAllocateStateSeats(), grCalcBonusSeats() (+4 more)
