...
const CONTROL_PANEL = {
  ...
  "Income Gradient": "Κλίμακα Εισοδήματος",
  "Negative = low-income surge · Positive = affluent surge": "Αρνητικό = άνοδος χαμηλού εισοδήματος · Θετικό = άνοδος εύπορων",
...
const MAP = {
  ...
  "GDP": "ΑΕΠ",
  "GDP:": "ΑΕΠ:",
  "GDP per Capita": "ΑΕΠ κατά κεφαλήν",
  "GDP per Capita:": "ΑΕΠ κατά κεφαλήν:",
  "GDP Year": "Έτος ΑΕΠ",
  "Total": "Σύνολο",
...
const SEAT_DIFF = {
  ...
  "October 2009 Legislative": "Οκτώβριος 2009",
